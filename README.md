...
```
git clone git@github.com:LamcatUK/cb-global42026.git my-new-project
cd my-new-project
./setup.sh
```
...
renames every `cb-global42026` / `CB Global 4` / `cb_global42026_` /
`CB_Global_4_` reference across the whole repo to match, and resets git to a
