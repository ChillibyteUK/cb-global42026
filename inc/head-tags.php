 ...
 * @return void
 */
function cb_global42026_preload_fonts() {
...
add_action( 'wp_head', 'cb_global42026_preload_fonts', 1 );
 ...
 * @return void
 */
function cb_global42026_head_tags() {
 ...
 * @return void
 */
function cb_global42026_gtm_noscript() {
	if ( is_user_logged_in() ) {
		return;
	}
...
add_action( 'wp_body_open', 'cb_global42026_gtm_noscript' );
